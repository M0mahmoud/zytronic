import { Calendar, Users, Bed, ArrowUpRight } from "lucide-react";

export default function HeroSection() {
  return (
    <section className='relative h-dvh flex flex-col pt-24'>
      {/* TODO */}
      <div
      ...
      <div className='absolute bottom-0 left-0 bg-[#E9F0EC] h-[60px] z-[1] w-full' />
      ...
      <div className='relative z-10 flex-1 flex items-center justify-center w-full h-full'>
        <div className='text-center text-white max-w-4xl mx-auto px-4'>
          ...
          <div className='flex flex-col sm:flex-row gap-4 justify-center'>
            <button className='h-12 py-2 bg-yellow-500  text-black font-semibold px-8 rounded-xl cursor-pointer flex items-center justify-center gap-4'>
              Explore More <ArrowUpRight />
            </button>
            <button className='h-12 py-2 border-2 border-white text-black px-8 bg-white rounded-xl cursor-pointer flex items-center justify-center gap-4'>
